...
Shell scripts to compile the ~tar.gz~ source archives for the publisher of choice and for [[https://arxiv.org][arXiv]].
This includes the scripts to create the figures, tables, and numbers.
